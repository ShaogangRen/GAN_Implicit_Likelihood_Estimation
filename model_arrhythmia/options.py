...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', default='cifar10', help='folder | cifar10 | mnist | kdd | arrhythmia ')
        self.parser.add_argument('--dataroot', default='data_dir/', help='path to dataset')
        ...
        self.parser.add_argument('--lrG', type=float, default=0.00001)
        self.parser.add_argument('--lrD', type=float, default=0.00001)
        self.parser.add_argument('--lrIG', type=float, default=0.00001)
        self.parser.add_argument('--var_lr', type=float, default=0.00001)
        ...
        self.parser.add_argument('--K', type=int, default=90, help='K is cluster number')
        ...
        self.parser.add_argument('--iter_gan', type=int, default=2000,
                                 help='frequency of returning to gan training')
        self.parser.add_argument('--test_interv', type=int, default=1000, help='frequency of testing')
